...
// Syscall numbers (M6)
// ============================================================
constexpr u64 NT_TEST_SYSCALL     = 0;   // M6 smoke test
constexpr u64 NT_TERMINATE_THREAD = 1;   // terminate current thread
constexpr u64 NT_WRITE_CONSOLE    = 2;   // stub: print string from user
